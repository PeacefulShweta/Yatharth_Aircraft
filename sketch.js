...
function preload(){
  arrowimg =loadAnimation("missile1.png","missile2.png","missile3.png") 
 ...
 Enemyimg2 = loadImage("enemy2.png") 
  ...
  playerimg = loadAnimation("aircraft1.png","aircraft2.png","aircraft3.png","aircraft4.png");
...
function setup() {
  ...
  player=createSprite(70,height/2,70,70)
...
function Weapon(){
 if(frameCount %5 === 0){
  var weapon = createSprite(70,320,5,20);
   weapon.addAnimation("missile",arrowimg)
